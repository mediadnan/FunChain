...
test_cases = [
    ...
    param('chain(increment, double)', 3, 8, nodes.Chain, id="chain with two function nodes"),
    param('build(increment) | build(double)', 3, 8, nodes.Chain, id="chain with two function nodes with |"),
    param('chain(increment, increment, increment, increment, increment)', 2, 2 + 5, nodes.Chain, id="chain with multiple function nodes"),
    param('build(double) * chain(increment)', [3], [4, 4], nodes.Chain, id="chain with spread results with *"),
    param('chain(double, foreach(increment))', [3], [4, 4], nodes.Chain, id="chain with spread results with foreach"),

...
#     inp = object()
#     result = PASS._process(inp, basic_reporter)
...
#     assert node._process(5, basic_reporter) == (True, 6), "the processing result wasn't as expected"
...
#     assert not basic_reporter.counter, "reporter's counter reg wasn't empty"
#     assert not basic_reporter.failures, "reporter's failed reg wasn't empty"
#     assert node._process(5, basic_reporter) == (False, None), "the processing result wasn't as expected"
...
#     coll.set_title()
#     assert coll._process(input, basic_reporter) == result
#
#
...
#     success, result = chain_match._process(input, basic_reporter)
#     assert not success
...
#     success, result = node._process((2, 5, 8), basic_reporter)
#     assert success
...
#     node = for_each(chain_node_inc)
#     success, result = node._process(3, basic_reporter)
#     assert not success
#     assert result == ()
